...
module.exports = {
    ...
    .setDescription('```I am a discord bot created by Λrkan#0066 for the purpose of helping out the Party Animals Server!```')
    .addFields(
     { name: 'Details', value: '```Specifics```' },
     { name: 'Coded by', value: '```Arkan#0066```', inline: true },
     { name: 'Coded in', value: '```JavaScript using Discord.js```', inline: true },
     { name: "Uptime", value:  `Uptime: ${days} days ${hours} hours ${minutes} minutes ${seconds} seconds`, inline: true},
 )

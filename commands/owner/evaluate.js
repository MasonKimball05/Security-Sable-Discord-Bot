...
module.exports = {
    name: "evaluate",
    category: "owner",
    description: "evaluates the bot for the owner",
    accessableby: "Owner", 
run: async (bot, message, args) => {
  ...
  try {
    ...
    if (code.includes(`SECRET`) || code.includes(`TOKEN`) || code.includes(`token`) || code.includes(`Token`) || code.includes("process.env")) {
